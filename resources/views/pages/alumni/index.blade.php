...
<div class="grid grid-cols-1 gap-6">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="p-4 border-t border-gray-100 dark:border-gray-800 sm:p-6">
            <div class="space-y-6">
                <div class="overflow-hidden" x-data="alumniTable()">
                    ...
                    <div x-show="!isLoading" class="max-w-full overflow-x-auto">
                        <table class="min-w-full">
                                ...
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-left border border-gray-100 dark:border-white/[0.05]">
                                        <div class="flex items-center justify-between w-full cursor-pointer" @click="sortBy('name')">
                                            <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">Nama Lengkap</p>
                                    ...
                                    <th class="px-4 py-3 text-right border border-gray-100 dark:border-white/[0.05]">
                                        <div class="flex items-center justify-between w-full">
                                            <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">Tempat Lahir</p>
                                        </div>
                                    </th>
                                    <th class="px-4 py-3 text-right border border-gray-100 dark:border-white/[0.05]">
                                        <div class="flex items-center justify-between w-full">
                                            <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">Tanggal Lahir</p>
                                        </div>
                                    </th>
                                    <th class="px-4 py-3 text-right border border-gray-100 dark:border-white/[0.05]">
                                        <div class="flex items-center justify-between w-full">
                                    ...
                                    <th class="px-4 py-3 text-right border border-gray-100 dark:border-white/[0.05]">
                                        <div class="flex items-center justify-between w-full">
                                            <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">Program</p>
                                        </div>
                                    </th>
                                    <th class="px-4 py-3 text-right border border-gray-100 dark:border-white/[0.05]">
                                        <div class="flex items-center justify-between w-full">
                                            <p class="font-medium text-gray-700 text-theme-xs dark:text-gray-400">NIK</p>
                                        </div>
                                    </th>
                            ...
                            <tbody>
                                <template x-for="(alumni, index) in paginatedData" :key="alumni.id">
                                    <tr class="border-t border-gray-100 dark:border-white/[0.5]">
                                        ...
                                        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05] text-center">
                                            <template>
                                                <img :src="" class="w-10 h-10 object-cover rounded-lg mx-auto">
                                            </template>
                                            <template>
                                        ...
                                        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05]">
                                            <p class="text-theme-sm font-medium text-gray-800 dark:text-white/90" x-text="alumni.full_name"></p>
                                        </td>
                                        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05]">
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="alumni.place_of_birth"></p>
                                        </td>
                                        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05]">
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="alumni.date_of_birth"></p>
                                        </td>
                                        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05]">
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="alumni.full_address"></p>
                                        </td>
                                        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05]">
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="alumni.wa_number"></p>
                                        </td>
                                        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05]">
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="alumni.course_id"></p>
                                        </td>
                                        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05]">
                                            <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="alumni.nik"></p>
                                        </td>
                                        <td class="px-4 py-3 border border-gray-100 dark:border-white/[0.05] text-center">
                                            <div class="flex items-center justify-center gap-2">
                                                <button @click="viewDetail(alumni.id)" class="text-gray-500 hover:text-brand-500 dark:text-gray-400 dark:hover:text-brand-500" title="Edit">
                                                ...
                                                <button @click="deleteRow(alumni.id,alumni.full_name)" class="text-gray-500 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-500" title="Hapus">
                                                    <svg class="fill-current" width="20" height="20" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        >
                            ...
                            <div class="flex flex-col sm:flex-row overflow-y-auto flex-1">
                                ...
                                <div class="sm:w-60 flex-shrink-0 bg-gray-50 dark:bg-gray-800/50 flex flex-col items-center px-6 py-8 border-b sm:border-b-0 sm:border-r border-gray-100 dark:border-gray-800">
                                    ...
                                    <!-- Nama & Email -->
                                    <p class="text-sm font-semibold text-gray-800 dark:text-white/90 text-center"></p>
                                    <p class="text-xs text-gray-400 dark:text-gray-500 text-center mb-3"></p>
...
style="display: none;">
    ...
    <div @click.stop="" class="relative w-full rounded-3xl bg-white dark:bg-gray-900 max-w-[584px]" 
        ...
        <div class="relative w-full rounded-3xl bg-white p-4 dark:bg-gray-900 sm:p-6 lg:p-8 custom-scrollbar">
            <form id="alumniForm" autocomplete="off" enctype="multipart/form-data">
                @csrf
                <input type="hidden" id="alumni_id" name="alumni_id">

                <h4 class="mb-6 text-lg font-medium text-gray-800 dark:text-white/90">
                    <span id="modal-title">Tambah Alumni</span>
                </h4>
                ...
                <div class="mb-4"
                    x-data="{
                        ...
                        async fetchData(keyword) {
                            try {
                                const response = await fetch(`{{ route('alumni.search') }}?keyword=${encodeURIComponent(keyword)}`);
                        ...
                        select(item) {
                            ...
                            this.selectedName = item.full_name;
                            this.dropdownSearch       = '';
                            this.dropdownResults      = [];
                            this.dropdownOpen         = false;

                            // Simpan id ke hidden input
                            document.getElementById('peserta_id').value = item.id;

                            // ← AUTO-FILL field lain berdasarkan data peserta terpilih
                            document.getElementById('f_place_of_birth').value = item.place_of_birth ?? '';
                            document.getElementById('f_date_of_birth').value  = item.date_of_birth ?? '';
                            document.getElementById('f_full_address').value   = item.full_address ?? '';
                            document.getElementById('f_wa_number').value      = item.wa_number ?? '';
                            document.getElementById('f_nik').value            = item.nik ?? '';
                        },
                        ...
                        clearSelected() {
                            ...
                            document.getElementById('f_place_of_birth').value = '';
                            document.getElementById('f_date_of_birth').value  = '';
                            document.getElementById('f_full_address').value   = '';
                            document.getElementById('f_wa_number').value      = '';
                            document.getElementById('f_nik').value            = '';
                            this.$nextTick(() => this.$refs.searchInput.focus());
                        },
                        ...
                        init() {
                            window.addEventListener('set-peserta', (e) => {
                                ...
                                document.getElementById('peserta_id').value = e.detail.id;
                            });

                            window.addEventListener('reset-alumni-form', () => {
                                this.dropdownOpen    = false;
                                this.dropdownSearch  = '';
                                this.dropdownResults = [];
                                this.selectedId      = null;
                    ...
                    @click.away="dropdownOpen = false; dropdownSearch = ''; dropdownResults = []"
                    @keydown.escape="dropdownOpen = false; dropdownSearch = ''; dropdownResults = []"
                >
                    ...
                    <input type="hidden" id="peserta_id" name="peserta_id" :value="selectedId">
                        ...
                        <ul class="max-h-52 overflow-y-auto py-1 custom-scrollbar">
                            ...
                            <template x-if="dropdownResults.length > 0">
                                <div>
                                    ...
                                    <template x-for="item in dropdownResults" :key="item.id">
                                        <li>
                                            ...
                                            >
                                                <div class="flex flex-col">
                                                    ...
                                                    <span class="text-xs text-gray-400" x-text="item.member_code"></span>
                                                </div>
                                                <svg x-show="selectedId == item.id" class="w-4 h-4 text-brand-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div id="error-peserta" class="mokursus-error-msg mt-1"></div>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="f_place_of_birth" name="place_of_birth"
                    ...
                    <div>
                        ...
                        <input type="date" id="f_date_of_birth" name="date_of_birth"
                            class="h-10 w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-3 text-sm text-gray-800 dark:text-white/90 focus:border-brand-300 focus:outline-none focus:ring-2 focus:ring-brand-500/10">
                    </div>
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">No. HP / WhatsApp</label>
                        <input type="text" id="f_wa_number" name="wa_number"
                            class="h-10 w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-3 text-sm text-gray-800 dark:text-white/90 focus:border-brand-300 focus:outline-none focus:ring-2 focus:ring-brand-500/10"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="f_full_address" name="full_address" rows="2"
                            class="w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 px-3 py-2 text-sm text-gray-800 dark:text-white/90 focus:border-brand-300 focus:outline-none focus:ring-2 focus:ring-brand-500/10 resize-none"
                            placeholder="Otomatis terisi setelah pilih peserta"></textarea>
                    </div>
                </div>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('alumniTable', () => ({
        ...
        async loadData() {
            this.isLoading = true;
            try {
                const response     = await fetch(`{{ route('alumni.data') }}?search=${this.search}&status=${this.statusFilter}&sort_column=${this.sortColumn}&sort_direction=${this.sortDirection}&per_page=${this.perPage}&page=${this.currentPage}`);
                const data         = await response.json();
        ...
        viewDetail(id) {
            fetch(`/admin/alumni/${id}`)
                ...
                .then(data => {
                    if (data.success) {
                        this.detailModal.alumni  = data.data;
        ...
        confirmDelete() {
            ...
            fetch(`/admin/alumni/${this.deleteModal.id}`, {
                method : 'DELETE',
                headers: {
...
// Reset form
    function resetForm() {
        ...
        window.dispatchEvent(new CustomEvent('reset-alumni-form'));
    }
</script>
@endpush